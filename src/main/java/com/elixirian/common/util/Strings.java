 ...
 * @version 0.0.6 (2010-04-29) formatMessage is taken from {@code com.elixirian.common.string.MessageFormatter}.
 */
public final class Strings
{
	...
	public static String format(final String message, final Object... args)
	{
		...
		while (args.length > i)
		{
			int position = message.indexOf(PLACE_HOLDER_SYMBOL, fromIndex);
		...
		if (0 == position)
		{
			...
			fromIndex = position + JUMP_SIZE;
			position = message.indexOf(PLACE_HOLDER_SYMBOL, fromIndex);
		}
		while (0 < position)
		{
