 ...
 */
public final class IntsToLongTotal
{
	private IntsToLongTotal()
	{
	}

	public static long total(final int number1, final int number2)
	{
		return (long) number1 + number2;
	}

	public static long total(final int number1, final int number2, final int number3)
	{
	...
	public static long total(final int[] numbers)
	{
		long total = 0;
