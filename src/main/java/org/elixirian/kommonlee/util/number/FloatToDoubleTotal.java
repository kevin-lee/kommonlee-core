 ...
 */
public final class FloatToDoubleTotal
{
  private FloatToDoubleTotal() throws IllegalAccessException
  {
  ...
  public static <T> double total(final T[] numberSource, final Function1<T, Float> floatMapper)
  {
    double total = 0;
  ...
  public static <T> double total(final Iterable<T> numberSource, final Function1<T, Float> floatMapper)
  {
    double total = 0;
    for (final T each : numberSource)
    {
