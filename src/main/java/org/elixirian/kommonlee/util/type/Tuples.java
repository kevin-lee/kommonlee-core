...
public final class Tuples
{
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8> Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> tuple8(final T1 value1,
      final T2 value2, final T3 value3, final T4 value4, final T5 value5, final T6 value6, final T7 value7,
      final T8 value8)
  {
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> tuple9(final T1 value1,
      final T2 value2, final T3 value3, final T4 value4, final T5 value5, final T6 value6, final T7 value7,
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> tuple10(
