 ...
 * </pre>
 *
 * The default implementation of the {@link Tuple9} interface. It is an immutable tuple object.
 *
...
public class ImmutableTuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
  ...
  public ImmutableTuple9(final T1 value1, final T2 value2, final T3 value3, final T4 value4, final T5 value5,
      final T6 value6, final T7 value7, final T8 value8, final T9 value9)
  {
    this.value1 = value1;
    this.value2 = value2;
    this.value3 = value3;
  ...
  public int hashCode()
  {
    return hash(value1, value2, value3, value4, value5, value6, value7, value8, value9);
  }
  ...
  public boolean equals(final Object tuple)
  {
    ...
    final Tuple9<?, ?, ?, ?, ?, ?, ?, ?, ?> that = castIfInstanceOf(Tuple9.class, tuple);
    /* @formatter:off */
    return null != that &&
  ...
  {
    return format("(%s, %s, %s, %s, %s, %s, %s, %s, %s)", value1, value2, value3, value4, value5, value6, value7,
        value8, value9);
  }
}