 ...
 * </pre>
 * 
 * The default implementation of the {@link Tuple7} interface. It is an immutable tuple object.
 * 
...
public class ImmutableTuple7<T1, T2, T3, T4, T5, T6, T7> implements Tuple7<T1, T2, T3, T4, T5, T6, T7>
{
  ...
  {
    return format("(%s, %s, %s, %s, %s, %s, %s)", value1, value2, value3, value4, value5, value6, value7);
  }
}