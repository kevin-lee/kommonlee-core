...
public class Function2Test
{
  ...
  private static class LineItem
  {
    ...
    public boolean equals(final Object lineItem)
    {
      ...
      return this.product == that.getProduct() || (null != this.product && this.product.equals(that.getProduct()));
    }
  ...
  private static final Product[] PRODUCTS = new Product[] { new Product(1L, "Product A"), new Product(2L, "Product B"),
      new Product(3L, "Product C"), new Product(4L, "Product D"), new Product(5L, "Product E"), new Product(6L, "Product F"),
      new Product(7L, "Product G") };
  ...
  public final void testPerform()
  {
    ...
    final Set<LineItem> itemSet3 = newLinkedHashSet();
    itemSet3.add(new LineItem(PRODUCTS[2], 3));
    itemSet3.add(new LineItem(PRODUCTS[4], 1000));
    itemSet3.add(new LineItem(PRODUCTS[5], 25));

    final List<Order> orderList = asList(new Order(1L, unmodifiableSet(itemSet1)), new Order(2L, unmodifiableSet(itemSet2)), new Order(3L,
    ...
    final Function2<Condition1<LineItem>, Order, List<LineItem>> itemFilter = new Function2<Condition1<LineItem>, Order, List<LineItem>>()
    {
      @Override
