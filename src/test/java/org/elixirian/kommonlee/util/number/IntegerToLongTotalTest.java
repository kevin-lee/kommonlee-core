...
import static org.elixirian.kommonlee.util.number.IntegerToLongTotal.*;
 ...
 */
public class IntegerToLongTotalTest
{
  ...
  public final void testTotalArrayOfT()
  {
    ...
    final long expected1 = total1;
    final long actual1 = total(numbers1, new Function1<ValueContainer<Integer>, Integer>() {
      @Override
    ...
    final long expected2 = total2;
    final long actual2 = total(numbers2, new Function1<ValueContainer<Integer>, Integer>() {
      @Override
      public Integer apply(final ValueContainer<Integer> input)
      {
        return input.getValue();
