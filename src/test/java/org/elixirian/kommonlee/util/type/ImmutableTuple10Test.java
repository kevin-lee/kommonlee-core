...
public class ImmutableTuple10Test
{
  ...
  public final void testHashCode()
  {
    ...
    final Tuple10<Integer, String, Boolean, BigInteger, BigDecimal, Date, List<String>, String, Integer, Long> expected =
      new ImmutableTuple10<Integer, String, Boolean, BigInteger, BigDecimal, Date, List<String>, String, Integer, Long>(
          999, "Kevin", true, BigInteger.valueOf(555L), new BigDecimal("1234.59"), date, Arrays.asList("Name", "Kevin",
              "Lee"), "Some value", 123, 777L);

    /* when */
    @SuppressWarnings("boxing")
    final Tuple10<Integer, String, Boolean, BigInteger, BigDecimal, Date, List<String>, String, Integer, Long> actual =
      Tuples.tuple(999, "Kevin", true, BigInteger.valueOf(555L), new BigDecimal("1234.59"), date,
          Arrays.asList("Name", "Kevin", "Lee"), "Some value", 123, 777L);
  ...
  @Test
  public final void testImmutableTuple10()
  {
    /* given */
    final Date date = new Date();
