...
public class CollectTest
{
  ...
  public final void test1()
  {
    ...
    System.out.println("list2.select: " + list2.select(new Condition1<Integer>() {
      @Override
      public boolean isMet(final Integer input)
      {
        return 5 < input.intValue();
    ...
    final ImmutableArrayList<Integer> emptyList = new ImmutableArrayList<Integer>();
    final ImmutableArrayList<Integer> resultFromEmptyListSelect = emptyList.select(new Condition1<Integer>() {
      @Override
      public boolean isMet(final Integer input)
      {
        return 5 < input.intValue();
