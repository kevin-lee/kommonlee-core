...
import static org.elixirian.common.util.number.IntsTotal.*;
...
public class IntsTotalTest
{
			...
			for (final int n2 : numbers2)
			{
				for (final int n3 : numbers1)
				{
					for (final int n4 : numbers2)
					{
						for (final int n5 : numbers1)
						{
							final int expected3 = n1 + n2 + n3 + n4 + n5 + total1;
							final int actual3 = total(n1, n2, n3, n4, n5, numbers1);
							// System.out.println("expected: " + expected3 + "\nactual:   " + actual3);
							assertTrue(expected3 == actual3);
							final int expected4 = n1 + n2 + n3 + n4 + n5 + total2;
							final int actual4 = total(n1, n2, n3, n4, n5, numbers2);
			...
			for (final int n2 : numbers4)
			{
				for (final int n3 : numbers3)
				{
					for (final int n4 : numbers4)
					{
						for (final int n5 : numbers3)
						{
							final int expected1 = n1 + n2 + n3 + n4 + n5 + total3;
							final int actual1 = total(n1, n2, n3, n4, n5, numbers3);
							// System.out.println("expected: " + expected1 + "\nactual:   " + actual1);
							assertTrue(expected1 == actual1);
							final int expected2 = n1 + n2 + n3 + n4 + n5 + total4;
							final int actual2 = total(n1, n2, n3, n4, n5, numbers4);
	...
	@Test
	public final void testIntegerIntegerIntegerIntegerInteger()
	{
		final Integer[] numbers1 = convertToBoxed(NUMBERS1);
		final Integer[] numbers2 = convertToBoxed(NUMBERS2);
