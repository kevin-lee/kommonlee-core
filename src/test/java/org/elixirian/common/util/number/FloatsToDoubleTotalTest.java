...
import static org.elixirian.common.util.number.FloatsToDoubleTotal.*;
...
public class FloatsToDoubleTotalTest
{
  ...
  public final void testSumFloatFloat()
  {
    ...
    for (final float n1 : numbers1)
    {
      ...
      {
        final double expected = (double) n1 + n2;
  ...
  public final void testSumFloatFloatFloat()
  {
    ...
    for (final float n1 : numbers1)
    {
      for (final float n2 : numbers2)
      {
        ...
        {
          final double expected = (double) n1 + n2 + n3;
    ...
    for (final float n1 : numbers1)
    {
      for (final float n2 : numbers2)
      {
        for (final float n3 : numbers1)
        {
          ...
          {
            final double expected = (double) n1 + n2 + n3 + n4;
      ...
      for (final float n2 : numbers2)
      {
        for (final float n3 : numbers1)
        {
          for (final float n4 : numbers2)
          {
            ...
            {
              final double expected = (double) n1 + n2 + n3 + n4 + n5;
      ...
      for (final float n2 : numbers2)
      {
        for (final float n3 : numbers1)
        {
          for (final float n4 : numbers2)
          {
            for (final float n5 : numbers1)
            {
              final double expected1 = (double) n1 + n2 + n3 + n4 + n5 + n1 + n2 + n3 + n4 + n5;
              final double actual1 = sum(n1, n2, n3, n4, n5, n1, n2, n3, n4, n5);
              // System.out.println("expected: " + expected1 + "\nactual:   " + actual1);
              assertTrue(expected1 == actual1);
              final double expected2 = (double) n1 + n2 + n3 + n4 + n5 + n1 + n2 + n3 + n4 + n5;
      ...
      for (final float n2 : numbers4)
      {
        for (final float n3 : numbers3)
        {
          for (final float n4 : numbers4)
          {
            for (final float n5 : numbers3)
            {
              final double expected3 = (double) n1 + n2 + n3 + n4 + n5 + n1 + n2 + n3 + n4 + n5;
              final double actual3 = sum(n1, n2, n3, n4, n5, n1, n2, n3, n4, n5);
              // System.out.println("expected: " + expected3 + "\nactual:   " + actual3);
              assertTrue(expected3 == actual3);
              final double expected4 = (double) n1 + n2 + n3 + n4 + n5 + n1 + n2 + n3 + n4 + n5;
      ...
      for (final float n2 : numbers2)
      {
        for (final float n3 : numbers1)
        {
          for (final float n4 : numbers2)
          {
            for (final float n5 : numbers1)
            {
              double total1 = (double) n1 + n2 + n3 + n4 + n5;
              ...
              double total2 = (double) n1 + n2 + n3 + n4 + n5;
      ...
      for (final float n2 : numbers4)
      {
        for (final float n3 : numbers3)
        {
          for (final float n4 : numbers4)
          {
            for (final float n5 : numbers3)
            {
              double total3 = (double) n1 + n2 + n3 + n4 + n5;
              ...
              double total4 = (double) n1 + n2 + n3 + n4 + n5;
      ...
      for (final Float n2 : numbers2)
      {
        for (final Float n3 : numbers1)
        {
          for (final Float n4 : numbers2)
          {
            ...
            {
              @SuppressWarnings("boxing")
              final double expected1 = (double) n1 + n2 + n3 + n4 + n5 + total1;
              final double actual1 = total(n1, n2, n3, n4, n5, numbers1);
              // System.out.println("expected: " + expected1 + "\nactual:   " + actual1);
              assertTrue(expected1 == actual1);

              @SuppressWarnings("boxing")
              final double expected2 = (double) n1 + n2 + n3 + n4 + n5 + total2;
      ...
      for (final Float n2 : numbers4)
      {
        for (final Float n3 : numbers3)
        {
          for (final Float n4 : numbers4)
          {
            ...
            {
              @SuppressWarnings("boxing")
              final double expected3 = (double) n1 + n2 + n3 + n4 + n5 + total3;
              final double actual3 = total(n1, n2, n3, n4, n5, numbers3);
              // System.out.println("expected: " + expected3 + "\nactual:   " + actual3);
              assertTrue(expected3 == actual3);

              @SuppressWarnings("boxing")
              final double expected4 = (double) n1 + n2 + n3 + n4 + n5 + total4;
