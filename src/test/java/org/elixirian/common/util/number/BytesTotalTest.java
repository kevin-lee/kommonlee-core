...
import static org.elixirian.common.util.number.BytesTotal.*;
...
public class BytesTotalTest
{
	...
	@Test
	public final void testTotalByteByte()
	{
	...
	@Test
	public final void testTotalByteByteByte()
	{
		final byte[] numbers1 = NUMBERS1;
		final byte[] numbers2 = NUMBERS2;
	...
	@Test
	public final void testTotalByteByteByteByte()
	{
		final byte[] numbers1 = NUMBERS1;
		final byte[] numbers2 = NUMBERS2;
	...
	@Test
	public final void testTotalByteByteByteByteByte()
	{
		final byte[] numbers1 = NUMBERS1;
		final byte[] numbers2 = NUMBERS2;
	...
	@Test
	public final void testTotalByteByteByteByteByteByteArray()
	{
		final byte[] numbers1 = NUMBERS1;
		final byte[] numbers2 = NUMBERS2;
	...
	@Test
	public final void testTotalByteArray()
	{
		final byte[] numbers1 = NUMBERS1;
		final byte[] numbers2 = NUMBERS2;
			...
			for (final Byte n2 : numbers2)
			{
				for (final Byte n3 : numbers1)
				{
					for (final Byte n4 : numbers2)
					{
						...
						{
							final int expected =
								n1.byteValue() + n2.byteValue() + n3.byteValue() + n4.byteValue() + n5.byteValue();
							final int actual = total(n1, n2, n3, n4, n5);
							// System.out.println("expected: " + expected + "\nactual:   " + actual);
							assertTrue(expected == actual);
						}
