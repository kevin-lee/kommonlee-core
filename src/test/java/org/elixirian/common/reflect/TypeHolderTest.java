...
public class TypeHolderTest
{
	...
	public final void testGetType()
	{
		...
		assertThat(nestedGenericType2.getType(), is(equalTo((Type) new ParameterizedTypeForTesting(Map.class,
				new Type[] {
						String.class,
						new ParameterizedTypeForTesting(List.class, new Type[] { new ParameterizedTypeForTesting(
								List.class, new Type[] { Integer.class }) }) }))));
	}
